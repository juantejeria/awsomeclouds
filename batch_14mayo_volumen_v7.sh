#!/bin/bash
# Recompute de volumen para 14mayo usando barril_seg_v7.pt
# Mismas alturas (altura_calc) que el batch original para que la comparación
# v6 vs v7 aísle el efecto del nuevo modelo de barril.
# Output: output_modelos3d_live_14mayo_v7/
set -e
cd "$(dirname "$0")"
