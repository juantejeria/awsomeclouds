"""
Editor de Silueta Completa - Training Mode.
UI para corregir la silueta completa (area verde) en frames extraidos.
Funciones: ver galeria, editar (pincel +/- y cortes), guardar, descartar.
"""
...
<html>
<head>
<title>Silueta Completa - Galeria</title>
...
<body>
<div class="header">
    <h1>Silueta Completa - {{ total }} frames</h1>
    <div class="stats">
...
<div class="header">
    ...
    <div class="nav-btns">
        ...
        <button id="btnOverlay" onclick="toggleOverlay()" style="background:#2a7 !important;color:#fff !important;">Silueta: ON</button>
...
<div class="main">
    ...
    <div class="sidebar">
        <div class="instructions">
            <b>Pincel +</b>: Pinta para AGREGAR area (lomo, patas faltantes).<br>
            <b>Pincel -</b>: Pinta para BORRAR area (espacio entre patas, sombras).<br>
            <b>Corte</b>: Lineas de corte para separar componentes.<br>
            Scroll o slider para cambiar tamano del pincel.<br>
            <b>Ctrl+Z</b>=deshacer, <b>Ctrl+S</b>=guardar, <b>flechas</b>=navegar.
        </div>
        <h3>Modo</h3>
        <div style="display:flex;flex-wrap:wrap;gap:2px;margin-bottom:6px;">
            <button class="mode-btn" id="modeCut" onclick="setMode('cut')">Corte</button>
            <button class="mode-btn active" id="modeBrushAdd" onclick="setMode('brush-add')">Pincel +</button>
            <button class="mode-btn" id="modeBrushErase" onclick="setMode('brush-erase')">Pincel -</button>
        </div>
        <div class="brush-controls" id="brushControls" style="display:flex;">
            <span>Pincel:</span>
...
let editMode = 'brush-add';  // 'cut', 'brush-add', 'brush-erase'
let brushRadius = 15;
...
def api_save():
    ...
    cv2.imwrite(str(DATA_DIR / f"{frame_id}_silueta.png"), barrel)
...
if __name__ == '__main__':
    print(f"\n  Silueta Completa Training Editor")
    print(f"  {len(load_index())} frames disponibles")
    print(f"  Abrir en: http://localhost:5056\n")
